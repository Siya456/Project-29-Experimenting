...
function setup() {
  ...
  //this was the original code - just trying to change it
  //leftWall = new Base(300, height / 2 + 50, 600, 100, "#8d6e63", true);
  //rightWall = new Base(width - 300, height / 2 + 50, 600, 100, "#8d6e63", true);

  bridge = new Bridge(15, { x: width / 2 - 150, y: height / 2 });
  //jointPoint = new Base(width - 600, height / 2 + 10, 40, 20, "pink", true);
